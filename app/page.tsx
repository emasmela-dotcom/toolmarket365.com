  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 max-w-4xl mx-auto">
                <div className="inline-flex items-center justify-center space-x-2 bg-accent-50 dark:bg-accent-950/30 px-6 py-3 rounded-lg border-2 border-accent-200 dark:border-accent-800">
                  ...
                  <span className="text-2xl sm:text-3xl font-bold text-accent-600 dark:text-accent-400">$1 Trillion+</span>
                  <span className="text-sm sm:text-base text-mono-700 dark:text-mono-300">global market by mid-2030s</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
              <div className="bg-mono-50 dark:bg-mono-900 rounded-lg p-6 border border-mono-200 dark:border-mono-700">
                ...
                <p className="text-sm text-mono-600 dark:text-mono-400">Increasing reliance on video for entertainment, marketing, and training across diverse sectors</p>
              </div>
              <div className="bg-mono-50 dark:bg-mono-900 rounded-lg p-6 border border-mono-200 dark:border-mono-700">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="p-2 bg-accent-100 dark:bg-accent-900/30 rounded-lg">
                ...
                <p className="text-sm text-mono-600 dark:text-mono-400">E-commerce integration and influencer marketing driving new revenue streams</p>
              </div>
              <div className="bg-mono-50 dark:bg-mono-900 rounded-lg p-6 border border-mono-200 dark:border-mono-700">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="p-2 bg-accent-100 dark:bg-accent-900/30 rounded-lg">
                ...
                <p className="text-sm text-mono-600 dark:text-mono-400">Easier-to-use technology and AI tools empowering creators at every level</p>
              </div>
            </div>
            <p className="text-center text-xs text-mono-500 dark:text-mono-500 italic">Now is the time to build your content brand and position yourself in this rapidly growing market.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-4 bg-gradient-to-r from-green-600 to-blue-600 dark:from-green-700 dark:to-blue-700 border-b-4 border-green-700 dark:border-green-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            <p className="text-lg sm:text-xl lg:text-2xl font-bold text-white leading-tight mb-3">💰 Save $159+/Month vs Buying Tools Separately</p>
            <p className="text-base sm:text-lg text-white/95 mb-4">Later ($18) + Jasper AI ($49) + Canva ($13) + Analytics ($99) = $179+/month</p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <Link href="/compare" className="inline-flex items-center px-6 py-2.5 bg-white text-green-600 font-bold rounded-lg hover:bg-green-50 transition-colors text-sm sm:text-base shadow-lg">See How We Compare →</Link>
              <Link href="/pricing" className="inline-flex items-center px-6 py-2.5 bg-green-700 text-white font-bold rounded-lg hover:bg-green-800 transition-colors text-sm sm:text-base border-2 border-white/30">View Pricing</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-3 bg-accent-600 dark:bg-accent-700 border-b-4 border-accent-700 dark:border-accent-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            <p className="text-base sm:text-lg lg:text-xl font-bold text-white leading-tight mb-3">CreatorFlow365 has several tools! Many you will not use, but also many that will strengthen your brand of content.</p>
            <div className="bg-white/10 dark:bg-white/5 rounded-lg p-3 border border-white/20">
              <p className="text-sm sm:text-base text-white/95 leading-tight"><strong>All tools are fully template-based and work immediately with zero cost.</strong> CreatorFlow365 never charges for API usage.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-mono-900 rounded-lg border border-blue-200 dark:border-blue-800 p-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2">Transparency Notice</h3>
                  <p className="text-sm text-blue-800 dark:text-blue-300">CreatorFlow365 provides everything we can offer at no extra cost beyond your subscription fee. Some advanced tools need external API integrations to run at full capacity. Those services charge their own fees; CreatorFlow365 never marks up or charges for third-party API usage.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div>
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h2 className="text-2xl font-bold text-mono-950 dark:text-mono-50">Your Content Library</h2>
                </div>
                <p className="text-sm text-mono-600 dark:text-mono-400 mb-3">Store, organize, and manage all your content in one secure cloud library.</p>
                <div className="space-y-2 mb-3">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-mono-600 dark:text-mono-400">Group your content into collections and folders</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-mono-600 dark:text-mono-400">Tag your content for quick retrieval</p>
                    </div>
                  </div>
                </div>
                <Link href="/tools/content-library" className="inline-flex items-center px-5 py-2 bg-accent-600 text-white text-sm font-medium rounded-lg hover:bg-accent-700 transition-colors">Open Content Library</Link>
              </div>
              <div className="bg-mono-50 dark:bg-mono-900 rounded-lg p-6 border border-mono-200 dark:border-mono-700">
                ...
                <ul className="space-y-2 text-sm text-mono-700 dark:text-mono-300">
                  <li className="flex items-center space-x-2"><span className="w-1.5 h-1.5 bg-accent-600 rounded-full" /><span>Text content, captions, and notes</span></li>
                  <li className="flex items-center space-x-2"><span className="w-1.5 h-1.5 bg-accent-600 rounded-full" /><span>Images, videos, and audio files</span></li>
                  <li className="flex items-center space-x-2"><span className="w-1.5 h-1.5 bg-accent-600 rounded-full" /><span>Documents and PDFs</span></li>
                  <li className="flex items-center space-x-2"><span className="w-1.5 h-1.5 bg-accent-600 rounded-full" /><span>Content templates and designs</span></li>
                  <li className="flex items-center space-x-2"><span className="w-1.5 h-1.5 bg-accent-600 rounded-full" /><span>Links and external resources</span></li>
                  <li className="flex items-center space-x-2"><span className="w-1.5 h-1.5 bg-accent-600 rounded-full" /><span>Performance metrics and analytics</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-4 bg-mono-50 dark:bg-mono-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-xl sm:text-2xl font-bold text-mono-950 dark:text-mono-50 mb-4 text-center">These are the tools we offer</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
              {toolSections.map((section, idx) => (
                <Link key={idx} href={`/tools?section=${section.slug}`} className="border-2 border-mono-200 dark:border-mono-700 rounded-lg p-4 text-center hover:border-accent-500 dark:hover:border-accent-500 transition-colors block">
                  <h3 className="text-base font-semibold text-mono-950 dark:text-mono-50 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">{section.title}</h3>
                </Link>
              ))}
            </div>
          </div>
