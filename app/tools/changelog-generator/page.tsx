...
export default function ChangelogGeneratorPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-4">
      <h1 className="text-2xl font-bold text-mono-950 dark:text-mono-50">Changelog generator</h1>
      <p className="text-sm text-mono-600 dark:text-mono-400">
        Paste GitHub commit subjects (or any lines); get a grouped Markdown changelog draft.
      </p>
      <input className={inputClass} placeholder="Version" value={version} onChange={(e) => setVersion(e.target.value)} />
      <textarea
