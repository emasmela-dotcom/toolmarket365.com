...
export default function ClientOnboardingChecklistGeneratorPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-4">
      <h1 className="text-2xl font-bold">Client Onboarding Checklist Generator</h1>
      ...
      <section className="rounded-lg border border-mono-300 dark:border-mono-700 p-4 text-sm space-y-3">
        <div>
          ...
          <p>Enter business type, service, and client type, then generate a structured checklist.</p>
        </div>
        <div>
          <h2 className="font-semibold mb-1">Expected Outcome</h2>
          <p>You get sections with concrete onboarding tasks tailored to your inputs.</p>
        </div>
      </section>
