...
const copy = {
  en: {
    ...
    description: "One line per expense: Category, amount, note",
    categorize: "Categorize",
    total: "Total",
  },
  es: {
    title: "Rastreador de gastos",
    description: "Una línea por gasto: Categoría, monto, nota",
    ...
    <div className="p-6 max-w-xl mx-auto space-y-3">
      ...
      {result ? (
        <div className="text-sm space-y-2">
          <p className="font-semibold">{c.total}: {result.grandTotal.toFixed(2)}</p>
