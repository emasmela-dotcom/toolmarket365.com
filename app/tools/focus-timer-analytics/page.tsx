  ...
  return (
    <div className="p-6 max-w-xl mx-auto space-y-4">
      ...
      <p className="text-sm text-mono-600 dark:text-mono-400">
        Log what you actually did today (pomodoros, focus minutes, breaks, interruptions). Get a
        simple productivity score and next-session goal.
      </p>
      <input
        className={inputClass}
        type="number"
        min={0}
        placeholder="Pomodoros completed"
      ...
      <input
        ...
        type="number"
        min={0}
        placeholder="Total focus minutes"
      ...
      {result ? (
        <div className="border border-mono-200 dark:border-mono-700 rounded p-4 space-y-3">
          <p className="text-lg font-semibold text-mono-900 dark:text-mono-100">
            Score: {result.productivityScore} / 100
          </p>
