...
const copy = {
  en: {
    ...
    linesHint: "Lines: label, url",
    hexAccentPlaceholder: "#hex accent",
    build: "Build",
  },
  es: {
    title: "Constructor de link-in-bio",
    linesHint: "Líneas: etiqueta, url",
    hexAccentPlaceholder: "Acento #hex",
    build: "Construir",
  },
}
...
export default function LinkInBioLandingBuilderPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-3">
      ...
      <p className="text-sm text-mono-600 dark:text-mono-400">{c.linesHint}</p>
      ...
      <input className={inputClass} placeholder={c.hexAccentPlaceholder} value={accentColor} onChange={(e) => setAccentColor(e.target.value)} />
